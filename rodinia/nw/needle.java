...
public class needle {
    ...
    public void usage(String[] args) {
        System.out.println("Usage: needle <max_rows/max_cols> <penalty> <num_threads>\n");
    ...
    public void nw_optimized(int[] input_itemsets, int[] output_itemsets, int[] referrence, int max_rows, int max_cols, int penalty) {
    ...
    public void runTest(String[] args){
        ...
        try {
            ...
            System.out.println(writer + "print traceback value GPU:");
            int i = max_rows - 2;
            int j = max_cols - 2;
            while (i >= 0 && j >= 0) {
                int nw = 0;
                ...
                if (i > 0 && j > 0) {
                    ...
                    nw = n = LIMIT; // Assuming LIMIT is defined as Integer.MAX_VALUE
                    w = input_itemsets[i * max_cols + j - 1];
                } else if (j == 0) {
                    nw = w = LIMIT;
                    n = input_itemsets[(i - 1) * max_cols + j];
