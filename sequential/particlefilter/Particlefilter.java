...
public class Particlefilter {
        static final double PI = Math.PI; // static final double PI = 3.1415926535897932;
     ...
     */
    public static void setIf(int testValue, int newValue, int[] array3D, int dimX, int dimY, int dimZ){
        int x, y, z;
        for(x = 0; x < dimX; x++){
            for(y = 0; y < dimY; y++){
                for(z = 0; z < dimZ; z++){
     ...
     */
    public static double randu(int[] seed, int index)
    {
        int num = A*seed[index] + C;
        seed[index] = (int) (num % M);
     ...
     */
    public static double randn(int[] seed, int index){
     ...
     * @param seed The seed array
     */
    public static void addNoise(int[] array3D, int dimX, int dimY, int dimZ, int[] seed){
        int x, y, z;
        for(x = 0; x < dimX; x++){
            for(y = 0; y < dimY; y++){
                for(z = 0; z < dimZ; z++){
     ...
     */
    public static void strelDisk(int[] disk, int radius) {
     ...
     */
    public static void dilate_matrix(int[] matrix, int posX, int posY, int posZ, int dimX, int dimY, int dimZ, int error) {
     ...
     */
    public static void imdilate_disk(int[] matrix, int dimX, int dimY, int dimZ, int error, int[] newMatrix) {
        int x, y, z;
        for(z = 0; z < dimZ; z++){
            for(x = 0; x < dimX; x++){
                for(y = 0; y < dimY; y++){
     ...
     */
    public static void getneighbors(int[] se, int numOnes, double[] neighbors, int radius){
        int x, y;
        int neighY = 0;
        int center = radius - 1;
        int diameter = radius*2 -1;
     ...
     */
   public static void videoSequence(int[] I, int IszX, int IszY, int Nfr, int[] seed){
        int k;
     ...
     */
    public static double calcLikelihoodSum(int[] I, int[] ind, int numOnes){
     ...
     */
    public static int findIndex(double[] CDF, int lengthCDF, double value){
        int index = -1;
        int x;
     ...
     */
    public static int findIndexBin(double[] CDF, int beginIndex, int endIndex, double value){
    ...
    public static void updateArrayXY(double[] arrayX, double[] arrayY, int[] seed, int Nparticles) {
     ...
     */
    public static void particleFilter(int[] I, int IszX, int IszY, int Nfr, int[] seed, int Nparticles){
        int max_size = IszX*IszY*Nfr;
        long start = get_time();
        ...
        for(k = 1; k < Nfr; k++){
            ...
            //updateArrayXY(arrayX, arrayY, seed, Nparticles);
            long error = get_time();
    ...
    public static void main(String[] args){
        String usage = "java Particlefilter x <dimX> y <dimY> z <Nfr> np <Nparticles>";
...
//        }
        ...
        //establish seed
        int[] seed = new int[Nparticles];
        int i;
        Random random = new Random();
        for(i = 0; i < Nparticles; i++) {
            seed[i] = random.nextInt() * i;
        }
        //malloc matrix
